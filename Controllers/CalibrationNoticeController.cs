...
namespace Calibration_Management_System.Controllers
{
    public class CalibrationNoticeController : Controller
    {
        ...
        public CalibrationNoticeController(ApplicationDbContext context, IWebHostEnvironment webHostEnvironment, UserManager<IdentityUser> userManager)
        {
            _context = context;
        ...
        public IActionResult Create(CalibrationNotice calibNotice, IFormFile _pathEQP, IFormFile _pathJIG)
        {
            ...
            string HTML = @"<html>
                    ...
                    <h1 style=""margin: 0; color: #000000; direction: ltr; font-family: 'Playfair Display', Georgia, serif; font-size: 30px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;"">Calibration Schedule Approval Request</h1>
                    </td>
                    </tr>
                    </table>
                    ...
                    <p style=""margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 21px;"">Please refer to the attachment link for the upcoming calibration schedule. </p>
                    <p style=""margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 21px;""> <a href=""http://172.29.2.96:8084/CalibrationNotice"">APPROVAL OF CALIBRATION SCHEDULE</a>
                    </ div >
                    </ div >
                    </ td >
                    </ tr >
            ...
            message.Subject = "Calibration System - Approval Request Notification";
            ...
            //message.To.Add(new MailAddress("edmon.isip@sanyodenki.com"));
